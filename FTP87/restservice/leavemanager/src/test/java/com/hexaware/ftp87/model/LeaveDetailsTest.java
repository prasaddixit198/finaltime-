 ...
 */
 ...
 /**
  ...
  public final void testApplyLeave(@Mocked final EmployeeDAO edao, @Mocked final LeavedetailsDAO ldao)
    ...
    new Expectations() {
      {
        ldao.count(2, "2019-12-26", "2019-12-27"); result = 0;
      }
    };
    new Expectations() {
      {
        ldao.count(2, "2019-12-30", "2019-12-30"); result = 1;
      }
    };
    new Expectations() {
      {
        ...
        edao.find(2);  result = new Employee(2, "Vennella", "Ftp",
            "vennella@gmail.com", "8583456645", sf.parse("2018-08-01"), 3, 1);
        edao.find(3); result = null;
      }
    };
    new Expectations() {
      {
        ldao.apply(2, "2019-12-26", "2019-12-26", 1, "EL", "PENDING", "sick", sf.format(today));
      }
    };
    new MockUp<Employee>() {
      @Mock
    ...
    String str1 = LeaveDetails.applyLeave(2, "2019-12-26", "2019-12-26", 1, "EL", "sick");
    ...
    String str4 = LeaveDetails.applyLeave(2, "2019-12-30", "2019-12-30", 1, "EL", "sick");
    assertEquals("already applied on given date", str4);
    String str5 = LeaveDetails.applyLeave(2, "2019-12-26", "2019-12-31", 6, "EL", "sick");
    assertEquals("insufficient leav balance", str5);
    String str6 = LeaveDetails.applyLeave(2, "2019-12-26", "2019-12-27", 2, "EL", "sick");
    ...
    String str8 = LeaveDetails.applyLeave(1, "2019-12-26", "2019-12-26", 1, "EL", "sick");
    assertEquals("Leave AutoApproved Successfully...1 Days ", str8);
    String str9 = LeaveDetails.applyLeave(1, "2019-12-26", "2019-12-29", 2, "EL", "sick");
