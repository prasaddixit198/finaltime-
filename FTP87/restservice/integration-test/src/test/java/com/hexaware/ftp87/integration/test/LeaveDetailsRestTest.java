...
@Test
   ...
   @Test
     public void testApplyLeave() throws AssertionError, URISyntaxException {
         String res1=given().accept(ContentType.JSON).contentType("application/json").body("{\"leavesdate\":\"2019-03-06\",\"leaveedate\":\"2019-03-08\",\"leavendays\":\"3\",\"leavereason\":\"sick\",\"leavetype\":\"EL\",\"leaveappliedon\":\"2018-11-29\"}").
       ...
       assertEquals("StartDate Must be Greater than EndDate...", res2);
        ...
        String res6 = given().accept(ContentType.JSON).contentType("application/json").body("{\"leavesdate\":\"2020-10-11\",\"leaveedate\":\"2020-10-12\",\"leavendays\":\"2\",\"leavereason\":\"sick\",\"leavetype\":\"EL\",\"leaveappliedon\":\"2018-11-30\"}").
        when().post(CommonUtil.getURI("/api/leavedetails/applyleave/3000")).getBody().asString();
